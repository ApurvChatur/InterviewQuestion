...
function HeaderComponent({ Redux, LogoutAPICall }) {
  return (
    ...
    <React.Fragment>
      <header className="sticky top-0 z-50 w-full backdrop-blur supports-[backdrop-filter]:bg-[#FFE8F5]/60 dark:supports-[backdrop-filter]:bg-[#9000FF]/60 text-[#9000FF] dark:text-[#FFE8F5]">
