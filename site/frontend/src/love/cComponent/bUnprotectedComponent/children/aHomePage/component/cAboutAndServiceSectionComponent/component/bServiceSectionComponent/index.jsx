              ...
              return (
                <React.Fragment key={index} >
                  <div className="p-4 md:w-1/2">
                    <div className="flex rounded-lg h-full bg-[#9000FF] dark:bg-[#FFE8F5] text-[#FFE8F5] dark:text-[#9000FF] bg-opacity-60 p-8 flex-col">
                      <div className="flex items-center mb-3">
                        <div className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-[#FFE8F5] dark:bg-[#9000FF] text-[#9000FF] dark:text-[#FFE8F5] flex-shrink-0">
