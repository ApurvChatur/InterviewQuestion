        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap flex-col">
          ...
          {Redux.state.ReceivedObject?.Retrieve?.BranchRetrieve?.subBranches?.map((each, index) => (
            <React.Fragment key={index}>
              <div className={`flex flex-wrap text-center bg-[#9000FF] dark:bg-[#FFE8F5] text-[#FFE8F5] dark:text-[#9000FF] bg-opacity-60 px-4 py-6 rounded-lg ${activeBranchGroup === each.title ? "" : "hidden"}`}>
