...
const ProfileUpdateComponent = ({ Redux, EventHandler, OnClick }) => {
  ...
  return (
    <React.Fragment>
      <section class="bg-[#FFE8F5] dark:bg-[#9000FF] text-[#9000FF] dark:text-[#FFE8F5] lg:px-20">
          ...
          <div class="lg:w-4/6 mx-auto">
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-[#9000FF] dark:bg-[#FFE8F5] text-[#FFE8F5] dark:text-[#9000FF]">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                  ...
                  <div class="w-12 h-1 bg-[#9000FF] dark:bg-[#FFE8F5] rounded mt-2 mb-4"></div>
                  <p class="text-base">{Redux.state.ReceivedObject?.Retrieve?.subtitle}</p>
                </div>
              </div>
              <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-[#9000FF] dark:border-[#FFE8F5] sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                <p class="leading-relaxed text-lg mb-4">{Redux.state.ReceivedObject?.Retrieve?.description}</p>
              </div>
            </div>
          </div>
        </div>
        <Separator className="bg-[#9000FF] dark:bg-[#FFE8F5]" />
        <div class="container px-5 py-12 mx-auto">
          <div class="flex flex-wrap -m-4">

            <div class="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#9000FF] dark:border-[#FFE8F5] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#9000FF] dark:border-[#FFE8F5] leading-none">Critical Information</h1>
                    ...
                    <div className='mb-2 mt-1 flex flex-1 space-x-4 items-center'>
                      <p>
                        <Avatar>
                          ...
                          <AvatarFallback className="bg-[#9000FF] dark:bg-[#FFE8F5] text-[#FFE8F5] dark:text-[#9000FF]">
                ...
                <div className="w-full mb-2">
                  <div className="relative">
                    ...
                    <input 
                      className="w-full bg-[#FFE8F5] dark:bg-[#9000FF] bg-opacity-40 rounded border 
                        border-[#9000FF] dark:border-[#FFE8F5]
                        focus:border-[#FFE8F5] dark:focus:border-[#9000FF] 
                        focus:bg-[#9000FF] dark:focus:bg-[#FFE8F5] 
                        focus:text-[#FFE8F5] dark:focus:text-[#9000FF] 
                        focus:ring-2 
                        focus:ring-[#9000FF] dark:focus:ring-[#FFE8F5] 
                        text-[#9000FF] dark:text-[#FFE8F5] 
            ...
            <div class="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#9000FF] dark:border-[#FFE8F5] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#9000FF] dark:border-[#FFE8F5] leading-none">Basic Information</h1>
            ...
            <div class="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#9000FF] dark:border-[#FFE8F5] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#9000FF] dark:border-[#FFE8F5] leading-none">More Information</h1>

                <div className="w-full mb-2">
                  <div className="relative">
                    <label className="leading-7 text-sm">Address</label>
                    <input 
                      className="mb-2 w-full bg-[#FFE8F5] dark:bg-[#9000FF] bg-opacity-40 rounded border 
                        border-[#9000FF] dark:border-[#FFE8F5]
                        focus:border-[#FFE8F5] dark:focus:border-[#9000FF] 
                        focus:bg-[#9000FF] dark:focus:bg-[#FFE8F5] 
                        focus:text-[#FFE8F5] dark:focus:text-[#9000FF] 
